    ...
    def test_one_time_alarm(self, day, hour):
        ...
        for _ in range(10):  # Máximo 10 intentos
            try:
                ...
                hour_option = hours_column.find_element(AppiumBy.XPATH, "//android.widget.EditText[@resource-id='com.sec.android.app.clockpackage:id/numberpicker_input' and @text='9, Hour']")
